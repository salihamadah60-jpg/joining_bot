...
import { Settings2, Key, ShieldCheck, ShieldX, Save, Eye, EyeOff } from "lucide-react";
...
export default function Settings() {
  ...
  useEffect(() => {
    if (settings) {
      setApiId((settings as Record<string, string>)["telegram_api_id"] ?? "");
      setAutoSyncInterval((settings as Record<string, string>)["auto_sync_interval_minutes"] ?? "30");
    }
  }, [settings]);
